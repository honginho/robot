...
<head>
	...
	<script>
		...
		var interval_time = 60;//間隔時間(單位為秒)
		var myVar= setTimeout(myrefresh, interval_time*100000);
    	$(document).on("mousemove touchstart touchmove touchend", function(e){
    		clearTimeout(myVar);
    		console.log("move");
    		myVar = setTimeout(myrefresh, interval_time*1000);
	       	e.preventDefault();
    	});
    	var joomlaHAHA = "fuck you";
    	function myMove(){
    		clearTimeout(myVar);
    		console.log("move");
    		myVar = setTimeout(myrefresh, interval_time*1000);
    	...
    	function myrefresh()
		 ...
		 function mouseOver(){
		 	...
		 	console.log(joomlaHAHA);
		 }
		 window.onmessage = function(e){
    		if (e.data == 'joomla_move') {
        	clearTimeout(myVar);
    		console.log("joomla move");
    		myVar = setTimeout(myrefresh, interval_time*1000);
	       	e.preventDefault();
    	}
};
...
<body>
	...
	<div id = "Stickers"></div>
	<div id = "hikashop" onmouseover = "mouseOver()"></div>
</body>
